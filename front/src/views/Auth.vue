      ...
      <div style="filter: blur(4px); background-color: rgba(0, 0, 0, 0.316);">
        ...
        <div class="glass-container">
          ...
          <p class="signup-text">Please login to your account</p>
            <input type="text" class="input" style="margin-top: 3%" id="lname" name="lastname" placeholder="   E-mail">
            <input type="text" class="input" style="margin-top: 5%" id="lname" name="lastname" placeholder="   Mot de passe">
            <div class="button-row">
              <v-btn class="button-signin no-shadow" color="#164465" height="7vh" width="25vh" onclick="">
                Connexion
              </v-btn>
              <v-btn class="button-signup no-shadow" height="7vh" width="25vh">
                Inscription
              </v-btn>
            </div>
        </div>
        </div>
        <div v-if="signup && !signin" id="centered-text">
          <h1 class="title">Inscription</h1>
          <p class="subtitle">Epic Road Trip</p>
          <button class="button-45" role="button">Get started</button> 
        </div>
  </div>
  </template>
